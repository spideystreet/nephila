...
raw.ansm_substance_class  ──►  silver.silver_ansm__substance_class
```
...
| `silver_ansm__substance_class` | Substance DCI → ANSM pharmacological class mappings (auto-resolution) |
...
{{ source('raw', 'ansm_substance_class') }}
```
